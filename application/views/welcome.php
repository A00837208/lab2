<table cols="3" class="gallery">
    <tr>
        <td class="oneimage">
            <a href="/application/data/Katmai_Crater_1980.jpg" data-lightbox="gallery"
        ...
        <td class="oneimage">
            <a href="/application/data/Caledonian_orogeny_fold_in_King_Oscar_Fjord.jpg" data-lightbox="gallery"
        ...
        <td class="oneimage">
            <a href="/application/data/Lands_End_Cape_Cornwall.jpg" data-lightbox="gallery"
